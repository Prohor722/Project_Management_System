            ...
            <div class="col-md-3 bg bg-light py-5 lrft-container">
                <form class="" action="/teacher/notice" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="email" name="notice_description" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">{{old('notice_description',$notice->notice_description)}}</textarea>
                    </div>
                    <div class="mb-3">
